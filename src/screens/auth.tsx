...
const Auth = () => {
  ...
  return (
    <div className='w-full h-screen flex flex-col  px-6 pt-12'>
      ...
      <TextInput min='1' max='30' value={value} handleChange={(e) => setValue(e)} placeholder='Enter Phone No.' />
      <h5 className=' font-semibold text-1xl mb-3'>Enter Your Mother’s Maiden Name</h5>
      <TextInput min='1' max='30' value={value} handleChange={(e) => setValue(e)} placeholder='Enter Name' />
