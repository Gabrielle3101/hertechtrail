...
const Login = () => {
  ...
  return (
    <div className='w-full h-screen flex flex-col  px-6 pt-12'>
      ...
      <h5 className=' font-semibold text-1xl mb-3'>Enmail</h5>
      ...
      <p className='font-semi-bold text-1xl text-gray-400 m-3'>Don't have an account? <span className='text-black ml-2'></span></p>
    </div>
  )
}
